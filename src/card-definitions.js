...
const CardDefinitions = (() => {
  ...
  const definitions = [
    ...
    card("aimed_fire", "조준 포격", "포격", 2, "rare", null, "enemy", false, "포격 명중률 +15%p, 기존 포격 피해 +6"),
    ...
    card("hard_turn", "급선회", "회피", 0, "rare", null, "sea", false, "이번 적 턴 적 명중률 -15%p, 카드 1장 드로우. 거리는 바꾸지 않는다."),
    card("smoke_sail", "연막 항해", "회피", 2, "epic", null, "sea", false, "거리를 3으로 만들고 이번 적 턴 적 명중률 -50%p"),
    ...
    card("gunner_shrapnel", "파편탄", "포격", 1, "normal", "gunner", "enemy", false, "포격 명중률로 기존 포격 피해의 60% 선체 피해(최소 1), 적 선원 2 피해"),
    card("gunner_double_broadside", "연속 포격", "포격", 2, "rare", "gunner", "enemy", false, "포격 명중률로 각각 기존 포격 피해의 70%를 주는 포격 2회"),
    card("gunner_powder_shift", "화약 재분배", "포격", 1, "rare", "gunner", "sea", false, "뽑기 더미에서 무작위 포격 카드 1장을 찾아 뽑고 이번 턴 비용 1 감소. 대상이 없으면 효과 없음."),
    card("gunner_overcharge", "과충전 포탄", "포격", 2, "epic", "gunner", "enemy", false, "포격 명중률로 기존 포격 피해 +8 선체와 돛 5 피해, 자신의 돛 3 피해"),
    card("gunner_magazine_open", "화약고 개방", "포격", 3, "epic", "gunner", "enemy", true, "명중이 보장되는 강력한 선체 피해, 자신의 선체 6 피해"),
    card("gunner_fleet_broadside", "전 함대 포문 개방", "포격", 3, "epic", "gunner", "allEnemies", true, "모든 적에게 기존 화력 기반 선체 피해와 돛 3 피해, 자신의 선체 4 피해"),
